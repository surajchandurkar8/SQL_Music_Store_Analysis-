...
-- Q5: Best customer (most money spent)
...
-- Alternative version with genre name
...
-- Q1: Amount spent by each customer on top-selling artist
...
SELECT * FROM CustomerSpending WHERE RowNo = 1;
